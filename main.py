...
class Uploader:
    ...
    def create_widgets(self):
        ...
        self.text_widget = tk.Text(self.text_frame, wrap=tk.WORD, width=80, height=30)  # Adjust width and height as needed
    ...
    def on_drop(self, event):
        ...
        if isinstance(files, str):  # Convert a single file path string into a list
            files = [files]
